...
def bateman_chain(A10, T1, T2, T3):
    ...
    # logarithmic time grid (very important)
...
# ---------- Decay series datas ---------- 
decay_series = {
    "Example 1: Ra-226 (Secular)": {
        "equilibrium": "Secular",
        "parent": ("Ra-226", 1600, "years"),
        "daughter": ("Rn-222", 3.8, "days"),
        "granddaughter": ("Po-218", 3.1, "minutes"),
        "stable": "Pb-206"
    },

    "Example 2: Th-232 (Secular)": {
        "equilibrium": "Secular",
        "parent": ("Th-232", 1.4e10, "years"),
        "daughter": ("Ra-228", 5.75, "years"),
        "granddaughter": ("Ac-228", 6.15, "hours"),
        "stable": "Pb-208"
    },

    "Example 3: U-238 (Secular)": {
        "equilibrium": "Secular",
        "parent": ("U-238", 4.5e9, "years"),
        "daughter": ("Th-234", 24, "days"),
        "granddaughter": ("Pa-234", 6.7, "hours"),
        "stable": "Pb-206"
    },

    "Example 4: Mo-99 (Transient)": {
        "equilibrium": "Transient",
        "parent": ("Mo-99", 66, "hours"),
        "daughter": ("Tc-99m", 6, "hours"),
        "granddaughter": ("Tc-99", 2.1e5, "years"),
        "stable": "Ru-99"
    },

    "Example 5: Ce-144 (Transient)": {
        "equilibrium": "Transient",
        "parent": ("Ce-144", 284.9, "days"),
        "daughter": ("Pr-144", 17.3, "minutes"),
        "granddaughter": ("Pr-144m", 7.2, "minutes"),
        "stable": "Nd-144"
    },

    "Example 6: Cs-137 (Transient)": {
        "equilibrium": "Transient",
        "parent": ("Cs-137", 30.05, "years"),
        "daughter": ("Ba-137m", 2.55, "minutes"),
        "granddaughter": ("Ba-137m*", 2.55, "minutes"),
        "stable": "Ba-137"
    }
}
...
if series_name == "Custom (User-defined)" and submitted:
    ...
    A10 = st.number_input(
        "Initial parent activity A₀ (relative)",
        min_value=0.01,
        max_value=1000.0,
        value=1.0,
        step=0.1
